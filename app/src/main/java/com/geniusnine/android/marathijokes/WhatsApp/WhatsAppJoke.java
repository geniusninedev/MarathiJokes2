...
public class WhatsAppJoke extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List = new String[] {"प्रेमात असो कि दवाखान्यात सगळे एकच विचारतात  Serious आहे का…..","तू बोलताना मी पहात बसतो,\n" +
                "तू हसताना मी पहात बसतो,\n" +
                "खरे तर तुझे समोरचे दात कसे किडले,\n" +
                "ह्याचाच विचार मी करत आसतो","गावात ओळखत नाही कुत्रं…\n" +
                "आणि Facebook वर\n" +
                ...
                "की\n" +
                "याला खरोखरच शिक्षा समजायचो."," कुणी चुकला की__आम्ही ठोकलाच!!","मि असाच आहे, पटल तर घ्या नाय तर द्या सोडून…."
                ," एका क्रिकेटप्रेमीने या खेळात बिलकुल रस नसलेल्या आपल्या बायकोला मॅच बघायला नेले. सुरुवातीच्या काही ओव्हर्समध्येच ती कंटाळली. " +
                "काही ओव्हर्सनंतर एकाबॅट्समनने सिक्सर लगावत चेंडू सीमापार भिरकावला. बायको म्हणाली, 'बरं झालं, बॉल हरवला, आता तरी खेळ थांबेल...'\n" +
        ...
        adapter = new ViewPagerAdapter(WhatsAppJoke.this,List);
